...
public class TransferResultService {
    ...
    public void confirm(String externalReferenceId, String externalEventId) {
        ...
        FundTransferRequest request = lockSubmittedRequest(externalReferenceId);
    ...
    private FundTransferRequest lockSubmittedRequest(String externalReferenceId) {
        FundTransferRequest request = fundTransferRequestRepository.findByExternalReferenceIdForUpdate(externalReferenceId)
